...
<div id="container" class="container">
	...
	<div id="body">
        <?php if($dataEdit){
            $id = $dataEdit->task_id;
            $duedate = $dataEdit->due_date;
			$class = $dataEdit->class;
			$assignment = $dataEdit->Assignment;
			$note = $dataEdit->Note; 
        }else{
            $duedate = "";
			$class = "";
      ...
      <div class="col-25">
            Due Date
						...
						<div class="col-75">
            <input type="date" name="duedate" value="<?php echo $duedate ?>" required/>
						</div></div>
						<div class="row">
      <div class="col-25">
            Class
      ...
      <div class="col-25">
			Assignment
						...
						<div class="col-75">
			<input type="text" name="assignment" value="<?php echo $assignment ?>" required/>
			</div></div>
						<div class="row">
      <div class="col-25">
			Note
						...
						<div class="col-75">
            <textarea name="note" rows="7" cols="30"><?php echo $note ?></textarea>
						</div></div>
						<div class="row">
            <input type="submit" name="save" value="Save">
			<input type="button" class="button" name="back" value="Cancel" onclick="history.back()">
			</div>
        </form>
	</div>
